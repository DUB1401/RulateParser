...
from Source.Functions import Autorizate, EnableMature, SecondsToTimeString
...
# Авторизация.	
Autorizate(Requestor, Settings)
# Включение отображения взрослого контента.
EnableMature(Requestor, Settings)
